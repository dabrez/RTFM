...
AI-powered Discord Chat Memory Bot that tracks and embeds all server messages into a Chroma vector database using FastEmbed (a lightweight embedding library).
